...
const AppDetails = () => {
    ...
    if (!singleApp) return <p className="text-center text-red-500 my-10">App not found!</p>;
        ...
        <div className="my-10 max-w-[1440px] mx-auto">
            ...
            <div className="bg-base-100 shadow-sm flex flex-col md:flex-row gap-7 p-8 rounded-xl">
                ...
                <div className="w-full">
                    ...
                    <button className="px-5 py-2 mt-5 bg-[#00D390] text-lg text-white font-semibold rounded-lg w-[235px] shadow-md hover:bg-[#00b57c]">
